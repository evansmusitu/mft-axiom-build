...
async function systemStatus(env) {
  ...
  try {
    const r = await fetch(env.PUBLIC_BASE + '/health', { headers: { 'accept': 'application/json', 'user-agent': 'MUSITU-FMI-Admin/1.0' } });
