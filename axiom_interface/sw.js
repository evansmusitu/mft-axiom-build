const CACHE='axiom-interface-phase3-v1';
const SHELL=['./','./index.html','./app.js','./projects.js','./outcome_contracts.js','./outcome_execution.js','./styles/tokens.css','./styles/app.css','./styles/projects.css','./styles/outcomes.css','./styles/outcome_execution.css','./manifest.webmanifest','./icons/axiom.svg'];
