...
check('release_repro_apk_matches',candidate.get('repro_unsigned_apk_sha256')==SOURCE.get('rebuild_evidence',{}).get('unsigned_apk_sha256'))
check('release_repro_web_matches',candidate.get('repro_web_sha256')==SOURCE.get('rebuild_evidence',{}).get('web_zip_sha256'))
