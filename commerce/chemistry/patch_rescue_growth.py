...
insert=(module_text('rescue-growth.mjs')+module_text('rescue-discovery.mjs')+module_text('rescue-render.mjs')+module_text('app-shell.mjs')+module_text('install.mjs')+module_text('rescue-kits.mjs'))
