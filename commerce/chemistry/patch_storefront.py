...
def phase3_render(text):
    ...
    text=once(text,'<a class="button" href="/chemistry/install">Start Free</a>','<a class="button" data-field-event="start_free" href="/chemistry/install">Start Free</a>','start free marker')
