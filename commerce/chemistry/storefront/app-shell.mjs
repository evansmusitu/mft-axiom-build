...
const appEsc=v=>String(v??'').replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot',"'":'&#39;'}[c]));
...
(()=>{
  ...
  const APP_CACHE='musitu-chemistry-app-shell-v2';
  const APP_STATIC=[
    '/chemistry/app',
    '/chemistry/assets/app-shell.css?v=2',
    '/chemistry/assets/app-shell.js?v=2',
  ...
  document.querySelectorAll('[data-app-jump]').forEach(a=>a.addEventListener('click',()=>{document.querySelector(a.getAttribute('href'))?.scrollIntoView({behavior:'smooth',block:'start'})}));
...
export function renderChemistryApp(){
  const name=appEsc(PRODUCT.name);
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="robots" content="noindex,nofollow"><meta name="theme-color" content="#07101f"><title>${name}</title><link rel="manifest" href="/chemistry/manifest.webmanifest"><link rel="apple-touch-icon" href="/chemistry/assets/musitu-chemistry-192.png"><link rel="stylesheet" href="/chemistry/assets/app-shell.css?v=2"><script src="/chemistry/assets/app-shell.js?v=2" defer></script></head><body><div class="app-shell"><header class="app-topbar"><div class="app-brand"><div class="app-icon" aria-hidden="true">M</div><div class="app-brand-copy"><strong>MUSITU Chemistry</strong><span>Education Nexus</span></div></div><span class="app-state" data-app-install-state>Installed</span></header><main class="app-main"><section class="app-hero"><span class="app-eyebrow">Chemistry Rescue 2026</span><h1>Your Chemistry workspace.</h1><p>One focused place to find what needs attention, revise deliberately, and prepare for exam pressure — without the public website chrome.</p><a class="app-primary" href="#rescue" data-app-jump>Continue Chemistry Rescue</a></section><section class="app-grid" aria-label="MUSITU rescue method"><article class="app-stat"><b>01</b><span>Diagnose what needs attention</span></article><article class="app-stat"><b>02</b><span>Revise with focus</span></article><article class="app-stat"><b>03</b><span>Prove under pressure</span></article></section><section class="app-section" id="rescue"><div class="app-section-head"><h2>Chemistry Rescue</h2><p>Free entry</p></div><div class="app-card"><article class="app-card-row"><span class="app-step">1</span><div><h3>Diagnose</h3><p>Start by identifying the Chemistry areas that deserve your attention instead of revising every topic equally.</p></div></article><article class="app-card-row"><span class="app-step">2</span><div><h3>Revise</h3><p>Work through targeted revision deliberately. Free access remains available without payment.</p></div></article><article class="app-card-row"><span class="app-step">3</span><div><h3>Prove</h3><p>Use exam-style and timed practice to expose what still breaks under pressure.</p></div></article></div><div class="app-actions"><a class="app-action primary" href="#rescue" data-app-jump>Continue Rescue</a><a class="app-action" href="/chemistry/plans">Premium options</a></div></section><section class="app-section"><div class="app-section-head"><h2>Quick access</h2><p>No explanation needed</p></div><div class="app-actions"><a class="app-action" href="/chemistry/support">Help & support</a><a class="app-action" href="/chemistry/verify">Verify release</a></div></section><p class="app-note"><strong>Installed app mode:</strong> MUSITU runs from the same secure web origin, but the installed launch surface is separated from the public marketing site. The app shell is kept available for offline reopening; payments and premium entitlement remain server-authoritative and are never satisfied from the offline shell.</p></main><nav class="app-nav" aria-label="App navigation"><a href="/chemistry/app" aria-current="page"><b>⌂</b><span>Home</span></a><a href="#rescue" data-app-jump><b>◫</b><span>Rescue</span></a><a href="/chemistry/plans"><b>◇</b><span>Premium</span></a><a href="/chemistry/support"><b>?</b><span>Help</span></a></nav></div><section class="app-onboarding" id="app-onboarding" hidden aria-label="First launch introduction"><div class="app-onboarding-card"><article class="app-onboarding-step" data-app-onboarding-step><span class="app-onboarding-kicker">Step 1 of 3</span><h2>Diagnose</h2><p>Find the Chemistry areas that need attention before spending time revising everything.</p></article><article class="app-onboarding-step" data-app-onboarding-step hidden><span class="app-onboarding-kicker">Step 2 of 3</span><h2>Revise</h2><p>Focus your effort where it matters instead of treating every topic as equally weak.</p></article><article class="app-onboarding-step" data-app-onboarding-step hidden><span class="app-onboarding-kicker">Step 3 of 3</span><h2>Prove</h2><p>Use exam pressure to reveal what still needs work, then repeat the cycle.</p></article><div class="app-dots" aria-hidden="true"><span data-app-onboarding-dot></span><span data-app-onboarding-dot></span><span data-app-onboarding-dot></span></div><div class="app-onboarding-actions"><button class="skip" id="app-onboarding-skip" type="button">Skip</button><button class="next" id="app-onboarding-next" type="button">Next</button></div></div></section></body></html>`;
}
