...
- Store Android APK: `https://payments.mftintelligence.com/store/bootstrap/MUSITU_Store_1.0.0.apk`
...
- Chemistry Android APK:
  ...
  - version: `1.3.0` / versionCode `10200`
  - bytes: `5892286`
...
3. Use the production Store URLs above. Do not sideload a locally rebuilt substitute.
...
3. Follow the Android install path and download `MUSITU_Store_1.0.0.apk` from the production Store route.
