...
from frontier_v5.scripts.verify_phase11_authority import verify_surface
...
def main():
 ...
 surface=json.loads((ROOT/'surface-map.json').read_text(encoding='utf-8'));authority_mode=verify_surface(surface)
