...
PROV_SCHEMA='musitu.revenueguard.v4_1.specialist_training_provenance_seal.v2'
...
def main():
    ...
    # Exact causal training ancestry is mandatory, not merely final artifact equality.
    pc=prov.get('contractnli') or {}; pq=prov.get('cuad') or {}
    ...
    if int(pq.get('run_id',-1))!=34749003397 or pq.get('training_head_sha')!=CUAD_TRAINING_HEAD_SHA: raise SystemExit('CUAD training ancestry drift')
    ...
    rep={
      'schema':'musitu.revenueguard.v4_1.specialist_dev_admission.v4',
